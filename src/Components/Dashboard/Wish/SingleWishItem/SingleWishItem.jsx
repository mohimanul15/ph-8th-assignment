...
const SingleWishItem = ({ wish_item, RemoveFromWish, handleCartClick }) => {
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-4 items-center">
                        ...
                        <div className="text-start">
                            ...
                            {
                                isAvai ?
                                    <button className="mt-1 bg-main flex items-center gap-2 py-3 px-5 rounded-4xl text-sm lg:text-lg font-bold text-white hover:animate-pulse"
                                        onClick={() => handleCartClick(p_id,price)}>
                                        Add To Cart
                                        <span><BsCart3 className="text-white font-bold" /></span>
                                    </button> :
                                    <p className="text-red-400">Product Not Available Yet!</p>
                            }
                        </div>
                    </div>

                    <div>
                        <button onClick={() => RemoveFromWish(p_id)}>
