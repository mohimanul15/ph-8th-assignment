...
const Hero = () => {
    return (
        <>
            <div className="bg-main rounded-4xl shadow-2xl shadow-main m-2 container mx-auto pb-55">
                ...
                <div className="flex items-center justify-center py-10 gap-6 flex-col max-w-6xl px-4 text-center mx-auto">
                    ...
                    <button className="rounded-4xl bg-white text-main font-bold text-sm md:text-xl py-4 px-7 hover:animate-pulse">
                        Shop Now
                    </button>
                </div>
            </div>
